...
// Range in meters. It will be selcted by Admin/super_admin as per venu. Default is 10m
...
if ($userResult) {
    ...
    // Fetch event details
    $eventQuery = "SELECT start_date, start_time, venue, meeting_type FROM events WHERE chapter_id = ? ORDER BY start_date DESC LIMIT 1";
